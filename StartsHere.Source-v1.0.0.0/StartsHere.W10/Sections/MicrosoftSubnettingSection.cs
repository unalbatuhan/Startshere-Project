...
{
    public class MicrosoftSubnettingSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public MicrosoftSubnettingSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://www.networkworld.com/category/microsoft-subnet/index.rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Microsoft Subnetting",

                    Page = typeof(Pages.MicrosoftSubnettingListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.MicrosoftSubnettingDetailPage>(true);
                    }
                };
            }
        }
