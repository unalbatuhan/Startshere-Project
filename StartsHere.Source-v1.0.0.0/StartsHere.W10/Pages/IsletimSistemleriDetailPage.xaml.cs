...
{
    public sealed partial class IsletimSistemleriDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public IsletimSistemleriDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new IsletimSistemleriSection());
