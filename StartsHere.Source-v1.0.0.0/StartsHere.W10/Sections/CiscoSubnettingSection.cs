...
{
    public class CiscoSubnettingSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public CiscoSubnettingSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://www.networkworld.com/category/cisco-subnet/index.rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Cisco Subnetting",

                    Page = typeof(Pages.CiscoSubnettingListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.CiscoSubnettingDetailPage>(true);
                    }
                };
            }
        }
