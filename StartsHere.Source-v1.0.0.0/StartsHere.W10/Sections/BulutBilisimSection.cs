...
{
    public class BulutBilisimSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public BulutBilisimSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://www.networkworld.com/category/cloud-computing/index.rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.BulutBilisimListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.BulutBilisimDetailPage>(true);
                    }
                };
            }
        }
