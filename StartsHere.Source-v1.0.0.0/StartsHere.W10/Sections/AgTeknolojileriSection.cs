...
{
    public class AgTeknolojileriSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public AgTeknolojileriSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://www.networkworld.com/category/tech-primers/index.rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.AgTeknolojileriListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.AgTeknolojileriDetailPage>(true);
                    }
                };
            }
        }
