...
{
    public sealed partial class AgTeknolojileriDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public AgTeknolojileriDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new AgTeknolojileriSection());
