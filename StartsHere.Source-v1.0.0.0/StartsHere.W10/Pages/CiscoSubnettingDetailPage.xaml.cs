...
{
    public sealed partial class CiscoSubnettingDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public CiscoSubnettingDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new CiscoSubnettingSection());
