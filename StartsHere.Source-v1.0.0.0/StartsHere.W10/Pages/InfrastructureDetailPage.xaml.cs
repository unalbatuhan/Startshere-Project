...
{
    public sealed partial class InfrastructureDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public InfrastructureDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new InfrastructureSection());
