...
{
    public sealed partial class MicrosoftSubnettingDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public MicrosoftSubnettingDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new MicrosoftSubnettingSection());
