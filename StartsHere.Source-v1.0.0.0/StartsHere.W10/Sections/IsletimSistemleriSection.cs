...
{
    public class IsletimSistemleriSection : Section<RssSchema>
    {
		private RssDataProvider _dataProvider;

		public IsletimSistemleriSection()
		{
		...
		public override async Task<IEnumerable<RssSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                Url = new Uri("http://www.networkworld.com/category/software/index.rss"),
            };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    Page = typeof(Pages.IsletimSistemleriListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.IsletimSistemleriDetailPage>(true);
                    }
                };
            }
        }
