...
{
    public sealed partial class IsletimSistemleriListPage : Page
    {
	    public ListViewModel ViewModel { get; set; }
        public IsletimSistemleriListPage()
        {
			ViewModel = ViewModelFactory.NewList(new IsletimSistemleriSection());
