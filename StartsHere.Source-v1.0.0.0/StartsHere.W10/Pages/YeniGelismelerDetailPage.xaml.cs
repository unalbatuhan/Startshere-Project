...
{
    public sealed partial class YeniGelismelerDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public YeniGelismelerDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new YeniGelismelerSection());
